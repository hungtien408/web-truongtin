        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            if (e.CommandName == "PerformInsert")
            {
                ...
                if (!string.IsNullOrEmpty(ImageName))
                {
                    ...
                    //ResizeCropImage.ResizeByCondition(strFullPath, 213, 198);
                    //ResizeCropImage.ResizeByCondition(strFullPath, 240, 250);
            ...
            else
            {
                ...
                if (!string.IsNullOrEmpty(ImageName))
                {
                    ...
                    FileImageName.UploadedFiles[0].SaveAs(Server.MapPath(strFullPath));
                    //ResizeCropImage.ResizeByCondition(strFullPath, 230, 250);
                    ResizeCropImage.CreateThumbNailByCondition("~/res/product/", "~/res/product/thumbs/", ImageName, 120, 120);
                }
            }
        }
